...
/// register a host as individual or business
const kRegisterHost = "RegisterHost";

/// register host email
const kRegisterHostEmail = "RegisterHostEmail";

/// verify otp
const kOtpVerification = "otpverification";

/// continue registration: get details business or individual host
const kContinueRegistration = "continueregistration";

/// upload required documents for host
